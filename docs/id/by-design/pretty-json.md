---
description: "Kenapa Deserve tidak punya opsi pretty JSON, karena pemformatan adalah tugas konsumen dan data yang dikirim tetap minified."
---

# Pretty JSON

Deserve tidak punya opsi pretty JSON, dan [`ctx.send.json()`](/id/response/json) selalu mengirim body minified. Indentasi adalah bantuan baca, dan membaca terjadi di sisi konsumen, bukan saat data dikirim.
...
## Data yang Dikirim Tetap Minified
...
Ini berpasangan dengan [kompresi](/id/by-design/compress). Body minified sudah kecil, dan runtime mengompresinya lebih jauh, jadi byte yang dikirim tetap seramping yang data izinkan. Pretty printing akan mendorong ke arah sebaliknya, menggembungkan body tepat sebelum dikompresi.
