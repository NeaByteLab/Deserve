...
- **[Quick Start](/getting-started/quick-start)** - Run the first server and route.
- **[Server Configuration](/getting-started/server-configuration)** - Configure options, middleware, and static files.
